...
(function(exports) {
  ...
  class Header extends Entry {
    init() {
      var header = $("<h1>" + capitalize(this.data.title) + "</h1>").css({"background": this.data.background, color: this.data.color});
  ...
  class Camera extends Entry {
    init() {
      ...
      viewer.css({width: 720, height: 405, "background-size": "contain", "background-repeat": "no-repeat", "text-align": "center"});
      var _this = this;
